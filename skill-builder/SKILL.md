...
**Step 6 — Validate.** Run through
[references/authoring-checklist.md](references/authoring-checklist.md) and avoid
the traps in [references/anti-patterns.md](references/anti-patterns.md).
